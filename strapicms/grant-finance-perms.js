...
async function run() {
  ...
  const now = new Date();
  const actions = [
    'api::finance-account.finance-account.find',
    'api::finance-account.finance-account.findOne',
    'api::finance-account.finance-account.create',
    'api::finance-account.finance-account.update',
    'api::finance-reports.finance-reports.generateStatement',
    'api::finance-financial-statement.finance-financial-statement.find',
    'api::finance-financial-statement.finance-financial-statement.findOne',
    'api::finance-financial-statement.finance-financial-statement.create'
  ];
