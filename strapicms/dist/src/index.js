...
async function seedNewsPage(strapi) {
    try {
        ...
        if ((newsPage === null || newsPage === void 0 ? void 0 : newsPage.id) && !(newsPage === null || newsPage === void 0 ? void 0 : newsPage.newsletterCard)) {
        ...
        if (!(newsPage === null || newsPage === void 0 ? void 0 : newsPage.featuredEvents) || newsPage.featuredEvents.length === 0) {
            ...
            for (const item of FEATURED) {
                let imageId = null;
                const imagePath = path_1.default.resolve(process.cwd(), '../frontend/public', item.image.slice(1));
            ...
            const id = newsPage === null || newsPage === void 0 ? void 0 : newsPage.id;
            if (id) {
...
async function seedSchoolAcademicPrograms(strapi) {
    try {
        // 1. Seed Main Programs Page if not already created
        const page = await strapi.entityService.findMany('api::school-academic-programs-page.school-academic-programs-page', {
        ...
        if (!page) {
            ...
            await strapi.entityService.create('api::school-academic-programs-page.school-academic-programs-page', {
                data: {
        ...
        const getOrUploadImage = async (relPath) => {
            var _a;
            const imagePath = path_1.default.resolve(process.cwd(), '../frontend/public', relPath.replace(/^\//, ''));
            if (!fs_1.default.existsSync(imagePath))
                return null;
            ...
            try {
                ...
                return ((_a = uploadedFiles === null || uploadedFiles === void 0 ? void 0 : uploadedFiles[0]) === null || _a === void 0 ? void 0 : _a.id) || null;
            }
            catch (e) {
        ...
        const existingPrograms = await strapi.entityService.findMany('api::school-academic-program.school-academic-program');
        if (!existingPrograms || existingPrograms.length === 0) {
            ...
            for (const prog of PROGRAMS) {
                ...
                await strapi.entityService.create('api::school-academic-program.school-academic-program', {
                    data: {
                        ...progData,
            ...
            try {
                if (strapi.documents) {
                    const docService = strapi.documents('api::school-academic-program.school-academic-program');
                    ...
                    if (docs && docs.length > 0) {
                        for (const doc of docs) {
                            const updateData = {};
                            if (!doc.pathwayImageLeft && pathwayLeftId)
                                updateData.pathwayImageLeft = pathwayLeftId;
                            if (!doc.pathwayImageTop && pathwayTopId)
                                updateData.pathwayImageTop = pathwayTopId;
                            if (!doc.pathwayImageBottom && pathwayBottomId)
                                updateData.pathwayImageBottom = pathwayBottomId;
                ...
                const allPrograms = await strapi.entityService.findMany('api::school-academic-program.school-academic-program', {
                    populate: ['pathwayImageLeft', 'pathwayImageTop', 'pathwayImageBottom']
                });
                if (allPrograms && allPrograms.length > 0) {
                    for (const prog of allPrograms) {
                        const updateData = {};
                        if (!prog.pathwayImageLeft && pathwayLeftId)
                            updateData.pathwayImageLeft = pathwayLeftId;
                        if (!prog.pathwayImageTop && pathwayTopId)
                            updateData.pathwayImageTop = pathwayTopId;
                        if (!prog.pathwayImageBottom && pathwayBottomId)
                            updateData.pathwayImageBottom = pathwayBottomId;
                        if (Object.keys(updateData).length > 0) {
                            await strapi.entityService.update('api::school-academic-program.school-academic-program', prog.id, {
                                data: updateData
                            });
...
async function seedOnlineLearning(strapi) {
    try {
        // Helper to find or upload image from frontend/public
        const getOrUploadImage = async (relPath) => {
            var _a;
        ...
        const page = await strapi.entityService.findMany('api::online-learning-page.online-learning-page', {
        ...
        if (!page) {
            ...
            await strapi.entityService.create('api::online-learning-page.online-learning-page', {
                data: {
        ...
        const existingCourses = await strapi.entityService.findMany('api::online-course.online-course');
        if (!existingCourses || existingCourses.length === 0) {
            ...
            for (const course of COURSES) {
                ...
                await strapi.entityService.create('api::online-course.online-course', {
                    data: {
                        ...courseData,
                        image: imageId,
                        isFeatured: true,
...
async function seedHomepage(strapi) {
    try {
        ...
        let homepageDocId = null;
        const docService = strapi.documents ? strapi.documents('api::homepage.homepage') : null;
        if (docService) {
...
async function seedLoginPage(strapi) {
    try {
        const getOrUploadImage = async (relPath) => {
            var _a;
            const imagePath = path_1.default.resolve(process.cwd(), '../frontend/public', relPath.replace(/^\//, ''));
        ...
        let loginDocId = null;
        const docService = strapi.documents ? strapi.documents('api::login-page.login-page') : null;
        if (docService) {
            const existingEntries = await docService.findMany({ locale: '*' });
            if (existingEntries && existingEntries.length > 0) {
...
async function seedPrivacyPage(strapi) {
    try {
        const LOCALES_DATA = {
            en: {
...
<p>Vous pouvez consulter, modifier ou résilier votre compte à tout moment. Si vous avez des questions ou des commentaires sur vos droits à la confidentialité, vous pouvez nous envoyer un e-mail à <strong>info@yahayaschool.com</strong>.</p>`,
        ...
        let privacyDocId = null;
        const docService = strapi.documents ? strapi.documents('api::privacy-page.privacy-page') : null;
        if (docService) {
            const existingEntries = await docService.findMany({ locale: '*' });
            if (existingEntries && existingEntries.length > 0) {
...
// ─────────────────────────────────────────────────────────────────────────────
function registerUserLifecycles(strapi) {
    strapi.db.lifecycles.subscribe({
        ...
        async beforeCreate(event) {
            ...
            try {
                let initials = 'XX';
                const firstName = String((_a = data.firstName) !== null && _a !== void 0 ? _a : '').trim();
                const lastName = String((_b = data.lastName) !== null && _b !== void 0 ? _b : '').trim();
                const username = String((_c = data.username) !== null && _c !== void 0 ? _c : '').trim();
                if (firstName && lastName) {
                    initials = `${firstName.charAt(0)}${lastName.charAt(0)}`;
                }
                else if (firstName) {
                    initials = `${firstName.charAt(0)}${(_d = firstName.charAt(1)) !== null && _d !== void 0 ? _d : 'X'}`;
                }
                else if (username && username.length >= 2) {
                    initials = username.substring(0, 2);
                }
                const schoolIdService = strapi.service('api::school-id-sequence.school-id-sequence');
        ...
        async afterCreate(event) {
            ...
            try {
                ...
                await auditService.log({
                    ...
                    entityId: String((_b = (_a = event.result) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : ''),
                    description: `New user created: ${(_d = (_c = event.result) === null || _c === void 0 ? void 0 : _c.username) !== null && _d !== void 0 ? _d : (_e = event.result) === null || _e === void 0 ? void 0 : _e.email}`,
                    metadata: {
                        username: (_f = event.result) === null || _f === void 0 ? void 0 : _f.username,
                        email: (_g = event.result) === null || _g === void 0 ? void 0 : _g.email,
                        schoolId: (_h = event.result) === null || _h === void 0 ? void 0 : _h.schoolId,
                    },
                    severity: 'info',
                });
            }
        ...
        async afterUpdate(event) {
            ...
            try {
                ...
                await auditService.log({
                    ...
                    entity: 'plugin::users-permissions.user',
                    entityId: String((_b = (_a = event.result) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : ''),
                    description: `User updated: ${(_d = (_c = event.result) === null || _c === void 0 ? void 0 : _c.username) !== null && _d !== void 0 ? _d : (_e = event.result) === null || _e === void 0 ? void 0 : _e.email}`,
                    metadata: { updatedFields: Object.keys((_g = (_f = event.params) === null || _f === void 0 ? void 0 : _f.data) !== null && _g !== void 0 ? _g : {}) },
                    severity: 'info',
                });
            }
            catch { }
        ...
        async afterDelete(event) {
            ...
            try {
                ...
                await auditService.log({
                    ...
                    entity: 'plugin::users-permissions.user',
                    entityId: String((_b = (_a = event.result) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : ''),
                    description: `User deleted: ${(_d = (_c = event.result) === null || _c === void 0 ? void 0 : _c.username) !== null && _d !== void 0 ? _d : (_e = event.result) === null || _e === void 0 ? void 0 : _e.email}`,
                    metadata: {
...
function registerERPLifecycles(strapi) {
    const autoIdModels = [
        ...
        strapi.db.lifecycles.subscribe({
            ...
            async beforeCreate(event) {
                ...
                if (data && !data[item.idField]) {
                    try {
                        const count = await strapi.db.query(item.model).count({});
    ...
    strapi.db.lifecycles.subscribe({
        async beforeCreate(event) {
            ...
            if (data && (model === null || model === void 0 ? void 0 : model.attributes)) {
...
// ─────────────────────────────────────────────────────────────────────────────
function registerContentManagerFilters(strapi) {
    ...
    strapi.server.use(async (ctx, next) => {
        await next();
        const isRelationEndpoint = ctx.method === 'GET' &&
            ctx.path &&
        ...
        try {
            ...
            strapi.log.info(`[YAHAYASCOOL] academicHead filter: allowed numeric IDs = [${[...numericIdSet].join(', ')}], ` +
            ...
            if (ctx.body) {
                if (Array.isArray(ctx.body.results)) {
                    ...
                    ctx.body.results = ctx.body.results.filter((item) => {
                    ...
                    strapi.log.info(`[YAHAYASCOOL] academicHead filter: ${before} → ${ctx.body.results.length} results after filtering`);
                ...
                if (Array.isArray(ctx.body.data)) {
                    ctx.body.data = ctx.body.data.filter((item) => {
                        const matchesNumericId = item.id != null && numericIdSet.has(Number(item.id));
                        const matchesDocumentId = item.documentId && documentIdSet.has(item.documentId);
                        return matchesNumericId || matchesDocumentId;
                    });
...
async function validateAcademicHeadIsSectionHead(event, strapi) {
    var _a, _b, _c, _d;
    const { data } = event.params || {};
    if (!data || !data.academicHead)
        return;
    try {
        const academicHeadVal = data.academicHead;
        let queryWhere = {};
        if (typeof academicHeadVal === 'object' && academicHeadVal !== null) {
            const docId = ((_b = (_a = academicHeadVal.connect) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.documentId) || academicHeadVal.id || academicHeadVal.documentId;
            if (!docId)
                return;
        ...
        const roleType = (_d = (_c = teacherLink.user) === null || _c === void 0 ? void 0 : _c.role) === null || _d === void 0 ? void 0 : _d.type;
        if (roleType !== 'section-head') {
            const { errors } = require('@strapi/utils');
            throw new errors.ValidationError(`The selected teacher (${teacherLink.name}) does not have the 'Section Head' user role. Only registered Section Heads can be assigned as the Academic Head.`);
        }
    }
    catch (err) {
        const { errors } = require('@strapi/utils');
...
async function updateStudentEnrollmentName(event, strapi) {
    var _a, _b, _c;
    ...
    if ((where === null || where === void 0 ? void 0 : where.id) && (!studentId || !courseOfferingId)) {
        try {
            ...
            if (existing) {
                if (!studentId)
                    studentId = (_a = existing.student) === null || _a === void 0 ? void 0 : _a.id;
                if (!courseOfferingId)
                    courseOfferingId = (_b = existing.courseOffering) === null || _b === void 0 ? void 0 : _b.id;
            }
        }
        catch (e) { }
    }
    ...
    if (courseOfferingId) {
        try {
            ...
            if (course) {
                courseName = course.name || ((_c = course.subject) === null || _c === void 0 ? void 0 : _c.name) || '';
            }
        }
        catch (e) { }
    }
...
async function updateTeacherAssignmentName(event, strapi) {
    var _a, _b, _c;
    const { data, where } = event.params || {};
    if (!data)
        return;
    ...
    let courseOfferingId = data.courseOffering;
    // For updates, fetch missing IDs from existing record
    if ((where === null || where === void 0 ? void 0 : where.id) && (!teacherId || !courseOfferingId)) {
        try {
            ...
            if (existing) {
                if (!teacherId)
                    teacherId = (_a = existing.teacher) === null || _a === void 0 ? void 0 : _a.id;
                if (!courseOfferingId)
                    courseOfferingId = (_b = existing.courseOffering) === null || _b === void 0 ? void 0 : _b.id;
            }
        }
...
// ─────────────────────────────────────────────────────────────────────────────
async function seedDefaultUsers(strapi) {
...
async function seedERPData(strapi) { }
async function seedSampleContent(strapi) { }
async function seedLmsData(strapi) { }
async function reconcileInvoiceBalances(strapi) { }
async function seedWallOfGratitude(strapi) {
    try {
...
// ─────────────────────────────────────────────────────────────────────────────
async function migrateLegacyAcademicData(strapi) {
    var _a, _b, _c;
    ...
    try {
        ...
        for (const sec of legacySections) {
            ...
            if (!homeroom) {
                ...
                const advisorId = ((_b = (_a = sec.teachers) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.id) || null;
            ...
            const defaultTeacher = ((_c = sec.teachers) === null || _c === void 0 ? void 0 : _c[0]) || null;
...
async function seedGradingPoliciesAndBlueprints(strapi) {
    var _a, _b;
    ...
    try {
        ...
        if (blueprintCount === 0) {
            ...
            for (const sub of subjects) {
                const isQuran = ((_a = sub.name) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes('qur')) || ((_b = sub.code) === null || _b === void 0 ? void 0 : _b.toLowerCase().includes('qur'));
                if (isQuran) {
