...
const financial_integrity_1 = require("../services/financial-integrity");
/**
 * finance-receipt controller
 * Extended with atomic applyWallet, combinedPayment, and verifyE2EScenario actions.
 */
exports.default = strapi_1.factories.createCoreController('api::finance-receipt.finance-receipt', ({ strapi }) => ({
    /**
     * POST /api/finance-receipts/apply-wallet
     * Body: { studentId, invoiceDocumentId, applyAmount }
     */
    async applyWallet(ctx) {
        var _a;
        const { studentId, invoiceDocumentId, applyAmount } = ((_a = ctx.request.body) === null || _a === void 0 ? void 0 : _a.data) || ctx.request.body || {};
        ...
        try {
            ...
            await strapi.db.transaction(async () => {
                ...
                if (invoiceDocumentId) {
                    ...
                    (0, financial_integrity_1.assertInvoiceIntegrity)({
                ...
                await strapi.db.query('api::wallet-transaction.wallet-transaction').create({
                    data: {
                        ...
                        user: ((_a = ctx.state.user) === null || _a === void 0 ? void 0 : _a.username) || 'System Admin',
                        reason: `Applied Advance Wallet to Invoice ${invoiceNumber}`,
                        transactionDate: new Date().toISOString(),
                    },
                });
                // Assert Wallet Invariant
                (0, financial_integrity_1.assertWalletIntegrity)({
                ...
                await strapi.db.query('api::finance-receipt.finance-receipt').create({
                    data: {
                        ...
                        cashierName: ((_b = ctx.state.user) === null || _b === void 0 ? void 0 : _b.username) || 'Cashier',
            ...
            strapi.log.error('[apply-wallet] Error:', (err === null || err === void 0 ? void 0 : err.message) || err);
            return ctx.badRequest((err === null || err === void 0 ? void 0 : err.message) || 'Failed to apply wallet.');
        }
    },
    /**
     ...
     */
    async combinedPayment(ctx) {
        var _a;
        const { invoiceId, walletAmount, cashAmount, bankAmount, mobileMoneyAmount, chequeAmount, paymentMethod, currency } = ((_a = ctx.request.body) === null || _a === void 0 ? void 0 : _a.data) || ctx.request.body || {};
        if (!invoiceId) {
        ...
        try {
            ...
            await strapi.db.transaction(async () => {
                ...
                const username = ((_a = ctx.state.user) === null || _a === void 0 ? void 0 : _a.username) || 'Admin Cashier';
                ...
                (0, financial_integrity_1.assertLedgerIntegrity)({
                ...
                (0, financial_integrity_1.assertJournalIntegrity)({
                    totalDebit,
                    totalCredit,
                });
            ...
            strapi.log.error('[combined-payment] Error:', (err === null || err === void 0 ? void 0 : err.message) || err);
            return ctx.badRequest((err === null || err === void 0 ? void 0 : err.message) || 'Failed to process combined payment.');
        }
    },
    /**
    ...
    async verifyE2EScenario(ctx) {
        ...
        try {
            ...
            const combinedRes1 = await this.combinedPayment({
                request: {
                    body: {
                        invoiceId: inv1.id,
                        walletAmount: 0,
            ...
            const combinedRes2 = await this.combinedPayment({
                request: {
                    body: {
                        invoiceId: inv2.id,
                        walletAmount: 2,
            ...
            const combinedRes3 = await this.combinedPayment({
                request: {
                    body: {
                        invoiceId: inv3.id,
                        walletAmount: 3,
            ...
            (0, financial_integrity_1.assertSystemWideReconciliation)(totalInvoiced, totalPaid, totalRemaining);
